    ...
    DataTable.prototype.render = function () {
        ...
        var columns = rowAction ? (_a = props.columns) === null || _a === void 0 ? void 0 : _a.concat({
            ...
            render: function (_, row) {
                return (React.createElement("ul", { className: 'row-action' }, rowAction.map(function (act, i) { return (React.createElement("li", { key: "act-" + i },
                    React.createElement("a", { key: i, href: 'javascript:;', onClick: function () { return act.props.onClick(row); } }, act.props.children))); })));
            }
        }) : props.columns;
        return (React.createElement("div", { className: 'component-table' },
            React.createElement("div", { className: 'table-header' },
                ...
                React.createElement("div", { className: 'batch-action' }, batchAction.map(function (act, i) { return (React.createElement(antd_1.Button, { key: i, onClick: function () { return act.props.onClick(selectedRows); }, type: act.props.type || 'primary', disabled: loading }, act.props.children)); }))),

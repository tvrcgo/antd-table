...
var DataTable = /** @class */ (function (_super) {
    ...
    DataTable.prototype.render = function () {
        var _this = this;
        var _a = this.state, selectedRowKeys = _a.selectedRowKeys, selectedRows = _a.selectedRows, loading = _a.loading, data = _a.data, page = _a.page;
        var _b = this.props, title = _b.title, onFetch = _b.onFetch, onChange = _b.onChange, multiSelect = _b.multiSelect, rowAction = _b.rowAction, rowActionTitle = _b.rowActionTitle, _c = _b.batchAction, batchAction = _c === void 0 ? [] : _c, props = __rest(_b, ["title", "onFetch", "onChange", "multiSelect", "rowAction", "rowActionTitle", "batchAction"]);
        // 翻页
        ...
        // 操作区
        var columns = rowAction ? props.columns && props.columns.concat({
        ...
        return (React.createElement("div", { className: 'component-table' },
            ...
            React.createElement(antd_1.Spin, { spinning: loading },
                React.createElement(antd_1.Table, __assign({ size: 'middle', rowKey: function (row) { return row._id || row.id; } }, props, { columns: columns, dataSource: data, pagination: pagination, rowSelection: multiSelect && rowSelection || undefined })))));
    };
    return DataTable;
}(React.Component));
